  ...
  return (
    <div className='lg:mt-0 mt-10'>
      <div className='bg-primary rounded flex justify-between items-center p-2'>
        <div className='font-semibold tracking-wider text-white lg:text-xl'>Product List</div>
        <Link to={'/dashboard/addProducts'} ><VscDiffAdded className='stroke-white fill-white text-2xl hover:scale-105 transition-all' /></Link>
        <div>
          <select
